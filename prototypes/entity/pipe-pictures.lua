return {
    ...
    gas_flow = {
        filename = "__base__/graphics/entity/pipe/steam.png", direction_count = 1, frame_count = 60, height = 30, line_length = 10, priority = "extra-high", width = 48
    },
    ...
    middle_temperature_flow = {
        filename = "__base__/graphics/entity/pipe/fluid-flow-medium-temperature.png", height = 18, priority = "extra-high", width = 160
    },
    straight_horizontal = {
        layers = {
